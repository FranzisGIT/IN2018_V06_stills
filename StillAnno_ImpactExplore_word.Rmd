...
```{r FigPCpies1, eval=TRUE, out.width='100%', fig.height= 17, fig.width=12, fig.cap="Pie charts of substrate distribution by locations, using the colour scheme identified above"}
...
```{r FigSMImpact, out.width='100%', fig.height= 17, fig.width=12, fig.align='center', fig.cap="Overview of impact scores over depth for each seamount"}
