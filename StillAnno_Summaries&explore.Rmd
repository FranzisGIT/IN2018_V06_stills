...
A linear of these dta regression has R^2^ of 0.555:
...
```{r MyFig4, fig.align='center', fig.height= 7, fig.width=10,  fig.cap="Relationship between density of VME taxa and percent cover of matrix forming coral"}
VMEanno_DensQ %>% 
