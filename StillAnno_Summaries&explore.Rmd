...
```{r FigPCpies, eval=FALSE, fig.cap="**Pie charts of substrate distribution at selected locations"}
...
```{r FigPCcoverComparison, out.width='100%', fig.align='center', fig.cap="Comparison of estimated and measured percent cover of matrix"}
